...
class DocumentComparatorByDurationTest {
    ...
    private static List<Document> getDocuments() {
        ...
        documents.add(new Document(7, "document name", DocumentType.TYPE_3, DocumentSize.A0));
        documents.add(new Document(2, "document name", DocumentType.TYPE_3, DocumentSize.A0));
        documents.add(new Document(7, "document name", DocumentType.TYPE_0, DocumentSize.A0));
        documents.add(new Document(-10, "document name", DocumentType.TYPE_2, DocumentSize.A0));
    ...
    void sort_whenListDocumentsSorted_thenEquals() {
        ...
        Collections.sort(actual, new DocumentComparatorByDuration());
