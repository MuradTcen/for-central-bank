...
class DocumentComparatorBySizeTest {

    private static List<Document> getDocuments() {
        List<Document> documents = new ArrayList<>();

        documents.add(new Document(600, "document name", DocumentType.TYPE_1, DocumentSize.A0));
        documents.add(new Document(1, "document name", DocumentType.TYPE_0, DocumentSize.A1));
        documents.add(new Document(7, "document name", DocumentType.TYPE_3, DocumentSize.A3));
        documents.add(new Document(2, "document name", DocumentType.TYPE_3, DocumentSize.A3));
        documents.add(new Document(7, "document name", DocumentType.TYPE_0, DocumentSize.A5));
        documents.add(new Document(-10, "document name", DocumentType.TYPE_2, DocumentSize.A3));
    ...
    void sort_whenListDocumentsSorted_thenEquals() {
        ...
        Collections.sort(actual, new DocumentComparatorBySize());
